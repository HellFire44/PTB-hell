...
<html lang="fr">
    ...
    <!-- Site Icons -->
    <link rel="logo-ptb" href="images/logo-ptb.png" type="image/x-icon" />
    <link rel="logo-ptb" href="images/logo-ptb.png">
		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-6 col-sm-6">
					<div class="left-top">
						<div class="email-box">
							<a href="#"><i class="fa fa-envelope-o" aria-hidden="true"></i> <?php echo $account; ?></a>
						</div>
					</div>
				</div>
				<div class="col-md-6 col-sm-6">
        ...
        <nav class="megamenu navbar navbar-default">
            <div class="container-fluid">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php"><img src="images/logo-ptb.png" alt="image" width="60px"></a>
                </div>
					...
					<div class="row">
						<div class="slider-content-area">
							<div class="slide-text">
								<h1 class="homepage-three-title">Passe <span> Temps</span> Boussiron</h1>
    ...
    <div id="about" class="section wb">
        <div class="container">
            <div class="row">
                    ...
                    <!-- Message-Box A propos de nous -->
                <div class="col-md-6">
                    <div class="message-box">
                        <h4>À propos de nous</h4>
                        <h2>Fonctionnement de l'Association</h2>
                        <p class="lead">Quisque eget nisl id nulla sagittis auctor quis id. Aliquam quis vehicula enim, non aliquam risus. Sed a tellus quis mi rhoncus dignissim.</p>

                        <p> Integer rutrum ligula eu dignissim laoreet. Pellentesque venenatis nibh sed tellus faucibus bibendum. Sed fermentum est vitae rhoncus molestie. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Sed vitae rutrum neque. Ut id erat sit amet libero bibendum aliquam. Donec ac egestas libero, eu bibendum risus. Phasellus et congue justo. </p>

                        <a href="about-us.php" class="btn btn-light btn-radius btn-brd grd1">En savoir plus</a>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="post-media wow fadeIn">
                        <img src="images/logo-ptb.png" alt="" class="img-responsive img-rounded">
                    </div>
                </div>
            </div>
    ...
    <div id="services" class="parallax section lb">
        <div class="container">
            ...
            <div class="section-title text-center">
                <h3>Actualités</h3>
                <p class="lead">Tenez vous informer des dernières actualités.</p>
            </div>>
            ...
            <div class="owl-services owl-carousel owl-theme">
                ...
                <div class="service-widget">
					...
					<div class="service-dit">
						<h3>Tournois de Palets en Fonte</h3>
						<p>Le traditionnelles tournois de palets en fonte aura lieu le 22-05-2022, si vous souhaitiez vous inscrire merci de vous reinsegner dans la catégorie tournois.</p>
					</div>
                </div>

                    <!-- Avant-Dernières Actualités -->
                <div class="service-widget">
                    <div class="post-media wow fadeIn">
            ...
            <div class="text-center">
                <a data-scroll href="#portfolio" class="btn btn-light btn-radius btn-brd">Voir plus d'images</a>
            </div>
        </div><!-- end container -->
    </div>

<!-- Bannieres avec image -->
    <div class="parallax section noover" data-stellar-background-ratio="0.7" style="background-color: #f2f3f5;">
        <!-- <div class="container">
            <div class="row text-center">
                <div class="col-md-6">
                    <div class="customwidget text-left">
                        ...
                        <a href="#services" data-scroll class="btn btn-light btn-radius btn-brd">Learn More3</a>
                    </div>
                </div>
				<div class="col-md-6">
            ...
            <div class="row">
				...
				<div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="widget clearfix">
                        ...
                        <ul class="footer-links hov">
							...
							<li><a href="about-us.php"> À propos de nous <span class="icon icon-arrow-right2"></span></a></li>
							<li><a href="services.php">Tournois de Palets <span class="icon icon-arrow-right2"></span></a></li>
							<li><a href="portfolio.php">Galerie Images<span class="icon icon-arrow-right2"></span></a></li>
                ...
                <div class="col-md-4 col-sm-4 col-xs-12">
                    <div class="footer-distributed widget clearfix">
                        <div class="widget-title">
                            <h3>Contact</h3>
							<p>Pour toute demande, merci de contacté un membre du bureau ou envoyer un mail a l'adresse suivante : contact-ptb@gmail.com</p>
                        </div>
        ...
        <div class="container">
            <div class="footer-distributed">
                <div class="footer-left">                   
                    <p class="footer-company-name">Tous Droits Réservés.&copy; 2022 <a href="#">Le Passe Temps Boussiron</a> Design By :
					<a>HellFire44</a></p>
                </div>
