   	...
   	<div class="banner-area banner-bg-1">
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					<div class="banner">
						<h2>Tournois de Palet sur Fontes</h2>
           ...
           <div class="row text-center">
				...
				<div class="col-md-3 col-sm-6">
					<div class="about-item">
						...
						<div class="about-text">
							<h3> <a href="#">Doublette à 3 Palets </a></h3>
							<p>  </p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
					<div class="about-item">
						...
						<div class="about-text">
							<h3> <a href="#">Lot </a></h3>
							<p>Toutes les équipes se verront décerner un prix de consolation. </p>
						</div>
					</div>
				</div>
				<div class="col-md-3 col-sm-6">
            ...
            <div class="contact_form">
                ...
                <form id="contactform" name="contactform">
                    <fieldset class="row-fluid">
                        ...
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <input type="text" name="username" id="username" class="form-control"
                                placeholder="Nom Prénom | Joueur 2">
                        </div>
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
	...
	<div id="services" class="parallax section lb">
        <div class="container">
            <div class="section-title text-center">
                <h3>Tableau Inscriptions Tournois de Palet</h3>
                <p class="lead">Réferencement de tout les équipe inscrite pour le tournois | une fois que vous voyez votre nom sur le tableau sela s'innivira que votre équipe et inscrite au tournois</p>
            </div>
