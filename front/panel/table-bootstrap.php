            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <!-- ---------------------
                            end Bootstrap Simple Table
                        ---------------- -->
                        <!-- Table -->
                        <!-- ---------------------
                            start Bootstrap Data From js
                        ---------------- -->
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Bootstrap Data From js</h4>
                                <h6 class="card-subtitle mb-3">Sample data From js</h6>
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-3">Basic sortable table</h6>
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <!-- ---------------------
                            start Table with radio button
                        ---------------- -->
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Table with radio button</h4>
                                <h6 class="card-subtitle mb-3">data with radiobutton</h6>
                                <table data-bs-toggle="table"
                                    data-url="dist/js/pages/data1.json"
                        ...
                        <!-- ---------------------
                            end Table with radio button
                        ---------------- -->
                    </div>
                    <div class="col-lg-6">
                        <!-- ---------------------
                            start Table with checkbox
                        ---------------- -->
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Table with checkbox</h4>
                                <h6 class="card-subtitle mb-3">data with checkbox</h6>
                                <table data-bs-toggle="table"
                                    data-url="dist/js/pages/data1.json"
