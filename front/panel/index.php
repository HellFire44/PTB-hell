					...
					<div class="user-pro-body">
						...
						<div class="dropdown">
							...
							<div class="dropdown-menu animated flipInY">
								...
								<!-- text-->
								<a href="javascript:void(0)" class="dropdown-item"><i class="ti-email"></i> Mail</a>
								<!-- text-->
				...
				<nav class="sidebar-nav">
					<ul id="sidebarnav">
						...
						<li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-email"></i><span class="hide-menu">Boîte de réception</span></a>
							<ul aria-expanded="false" class="collapse">
								<li><a href="app-email.html">Boîte Mail</a></li>
								<li><a href="app-email-detail.html">Détails  Mail</a></li>
								<li><a href="app-compose.html">Rédiger un Mail</a></li>
							</ul>
						</li>
									...
									<div class="col-md-12">
										<div class="d-flex no-block align-items-center">
											<div>
												...
												<p class="text-muted">Nombre de visite</p>
											</div>
											<div class="ms-auto">
												<h2 class="counter text-primary">valeur a définir</h2>
											</div>
										</div>
									</div>
									<div class="col-12">
									...
									<div class="col-md-12">
										<div class="d-flex no-block align-items-center">
											<div>
												...
												<p class="text-muted">Nombre de compte</p>
											</div>
											<div class="ms-auto">
												<h2 class="counter text-cyan"><?php echo $data['id'] ?></h2>
											</div>
										</div>
									</div>
									<div class="col-12">
