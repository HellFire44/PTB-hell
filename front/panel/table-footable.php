                        ...
                        <div class="form-group">
                                    ...
                                    <div class="accordion" id="accordionTable">
                                        <div class="card m-b-5">
                                            <div class="card-header" id="heading1">
                                                <h5 class="mb-0">
                                                <button class="btn btn-link" type="button" data-bs-toggle="collapse" data-bs-target="#col1" aria-expanded="true" aria-controls="col1">
                                                Collapsible Group Item #1
                                                </button>
                                                </h5>
                                            </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header" id="heading2">
                                                <h5 class="mb-0">
                                                <button class="btn btn-link collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#col2" aria-expanded="false" aria-controls="col2">
                                                Collapsible Group Item #2
                                                </button>
                                                </h5>
                                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="m-b-20">
                                        <button type="button" class="btn btn-info text-white" data-page-size="10">10</button>
                                        <button type="button" class="btn btn-info text-white" data-page-size="20">20</button>
                                        <button type="button" class="btn btn-info text-white" data-page-size="30">30</button>
                                    </div>
                                    <div class="table-responsive">
